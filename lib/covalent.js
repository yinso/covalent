  ...
  App = (function() {
    ...
    App.prototype.setupAddressRoute = function() {
      var $, app, _ref,
        _this = this;
      app = this;
      if ((_ref = this.$.address) != null) {
        _ref.change(function(evt) {
          var req;
    ...
    App.prototype.setupAnchor = function() {
      ...
      $(document).on('click', 'a', function(evt) {
        ...
        evt.preventDefault();
        console.log('App.a.clickMe', this.host, location.host, this.href, this.href.match(/^javascript/));
        if (this.href === '' || this.href.match(/^javascript/)) {
          console.log('App.a.JS', this.host, location.host, this.href);
          return false;
        }
        if (this.host === location.host) {
          normalizedURL = app.normalizeURL($(this).attr('href'));
      ...
      return $(document).on('submit', 'form', function(evt) {
